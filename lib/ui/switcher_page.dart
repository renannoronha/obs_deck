...
import 'package:obs_deck/ui/settings_page.dart';
import 'package:obs_deck/ui/studio_mode_off.dart';
import 'package:obs_deck/ui/studio_mode_on.dart';
        ...
        return Scaffold(
          ...
          body: ListView(
            children: [
              ...
              state.settingsState.studioButtonColor == Colors.green ? StudioModeOn(state) : StudioModeOff(state),
              Stack(
                children: [
                  Padding(
